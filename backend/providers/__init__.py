...
AI_PROVIDERS = {
    ...
    "manus": {
        ...
        "auth_type": "session_cookie",
        "auth_fields": [
            {"key": "api_key", "label": "API Key / Bearer Token", "placeholder": "Paste token", "secret": True},
        ],
        "auth_help": "Copy Bearer token from manus.im → DevTools → Network → any API request → Authorization header",
        "tier": 2,
        "refresh_interval": 1800,
    },
    "warp": {
